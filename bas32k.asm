...
USR     =   WRKSPC+003H ; "USR (x)" jump
OUTSUB  =   WRKSPC+006H ; "OUT p,n"
OTPORT  =   WRKSPC+007H ; Port (p)
DIVSUP  =   WRKSPC+009H ; Division support routine
DIV1    =   WRKSPC+00AH ; <- Values
DIV2    =   WRKSPC+00EH ; <-   to
DIV3    =   WRKSPC+012H ; <-   be
DIV4    =   WRKSPC+015H ; <-inserted
SEED    =   WRKSPC+017H ; Random number seed
LSTRND  =   WRKSPC+03AH ; Last random number
INPSUB  =   WRKSPC+03EH ; #INP (x)" Routine
INPORT  =   WRKSPC+03FH ; PORT (x)
NULLS   =   WRKSPC+041H ; Number of nulls
LWIDTH  =   WRKSPC+042H ; Terminal width
COMMAN  =   WRKSPC+043H ; Width for commas
NULFLG  =   WRKSPC+044H ; Null after input byte flag
CTLOFG  =   WRKSPC+045H ; Control "O" flag
LINESC  =   WRKSPC+046H ; Lines counter
LINESN  =   WRKSPC+048H ; Lines number
CHKSUM  =   WRKSPC+04AH ; Array load/save check sum
NMIFLG  =   WRKSPC+04CH ; Flag for NMI break routine
BRKFLG  =   WRKSPC+04DH ; Break flag
RINPUT  =   WRKSPC+04EH ; Input reflection
STRSPC  =   WRKSPC+051H ; Bottom of string space
LINEAT  =   WRKSPC+053H ; Current line number
BASTXT  =   WRKSPC+055H ; Pointer to start of program
BUFFER  =   WRKSPC+058H ; Input buffer
STACK   =   WRKSPC+05DH ; Initial stack
CURPOS  =   WRKSPC+0A2H ; <<<< Character position on line ** Top of Loader TEMPSTACK **
LCRFLG  =   WRKSPC+0A3H ; Locate/Create flag
TYPE    =   WRKSPC+0A4H ; Data type flag
DATFLG  =   WRKSPC+0A5H ; Literal statement flag
LSTRAM  =   WRKSPC+0A6H ; Last available RAM
TMSTPT  =   WRKSPC+0A8H ; Temporary string pointer
TMSTPL  =   WRKSPC+0AAH ; Temporary string pool
TMPSTR  =   WRKSPC+0B6H ; Temporary string
STRBOT  =   WRKSPC+0BAH ; Bottom of string space
CUROPR  =   WRKSPC+0BCH ; Current operator in EVAL
LOOPST  =   WRKSPC+0BEH ; First statement of loop
DATLIN  =   WRKSPC+0C0H ; Line of current DATA item
FORFLG  =   WRKSPC+0C2H ; "FOR" loop flag
LSTBIN  =   WRKSPC+0C3H ; Last byte entered
READFG  =   WRKSPC+0C4H ; Read/Input flag
BRKLIN  =   WRKSPC+0C5H ; Line of break
NXTOPR  =   WRKSPC+0C7H ; Next operator in EVAL
ERRLIN  =   WRKSPC+0C9H ; Line of error
CONTAD  =   WRKSPC+0CBH ; Where to CONTinue
PROGND  =   WRKSPC+0CDH ; End of program
VAREND  =   WRKSPC+0CFH ; End of variables
ARREND  =   WRKSPC+0D1H ; End of arrays
NXTDAT  =   WRKSPC+0D3H ; Next data item
FNRGNM  =   WRKSPC+0D5H ; Name of FN argument
FNARG   =   WRKSPC+0D7H ; FN argument value
FPREG   =   WRKSPC+0DBH ; Floating point register
FPEXP   =   FPREG+3     ; Floating point exponent
SGNRES  =   WRKSPC+0DFH ; Sign of result
PBUFF   =   WRKSPC+0E0H ; Number print buffer
MULVAL  =   WRKSPC+0EDH ; Multiplier
PROGST  =   WRKSPC+0F0H ; Start of program text area
STLOOK  =   WRKSPC+154H ; Start of memory test
